 ...
 */
//
public class MyAdapterDelete extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyAdapterDelete(Context context, List<ImageBean> imageBeen, OnChangeListener onChangeListener) {
        mContext = context;
